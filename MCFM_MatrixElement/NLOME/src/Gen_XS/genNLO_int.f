      double precision function genNLO_int(vector,wgt) 
      implicit none 
      include 'constants.f'
       include 'n_born.f' 
...
!-------- Phase Space 
      ...
      elseif((case.eq.'Zgamma').or.(case.eq.'Wgamma')) then
         if (flat) then
            ...
            call new_gen2l_gam(pin,vector,pswt,*999) 
...
!      call writeout(pborn) 
      ...
      genNLO_int=NLOME(pin)*pswt
!      write(6,*) 'genNLO int  = ',genNLO_int 
!      pause
      val=genNLO_int*wgt
