...
!====== FOR NLOME WE NEED TO ENSURE THAT THE FINAL STATE IS LEFT INVARIANT 
!====== THEREFORE HAVE COMMENTED OUT OPTIONS AND INSERTED GOTO 888 TO ENSURE 
!====== THAT ALWAYS FINAL=FINAL dipoles are called 
